...
public class TransformacionController {
    ...
    private static final String URL = "http://10.0.2.2:8080/ConUni_Soap_Java_GR05/CONUNI?wsdl";
    ...
    private String llamarServicio(String metodo, String parametro, double valor) {
        try {
